...
bazel build -c opt --config=stamp --config=x86_64_sysroot //src/pixie_cli:px_darwin_amd64 //src/pixie_cli:px_darwin_arm64 //src/pixie_cli:px
...
bazel run -c opt --config=stamp --config=x86_64_sysroot //src/pixie_cli:push_px_image
