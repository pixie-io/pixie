...
type LocustConfigFile struct {
	LocustFileTmpl       string               `protobuf:"bytes,1,opt,name=locust_file_tmpl,json=locustFileTmpl,proto3" json:"locust_file_tmpl,omitempty"`
	Phases               []*LocustPhaseConfig `protobuf:"bytes,2,rep,name=phases" json:"phases,omitempty"`
...
func (*LocustConfigFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_config_2443b84c186e4d9d, []int{0}
}
...
func (m *LocustConfigFile) GetLocustFileTmpl() string {
	if m != nil {
		return m.LocustFileTmpl
	}
	return ""
}
...
func (*LocustPhaseConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_config_2443b84c186e4d9d, []int{1}
}
...
func (*UserType) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_config_2443b84c186e4d9d, []int{2}
}
...
func (this *LocustConfigFile) Equal(that interface{}) bool {
	...
	if this.LocustFileTmpl != that1.LocustFileTmpl {
		return false
	}
...
func (this *LocustConfigFile) GoString() string {
	...
	s = append(s, "LocustFileTmpl: "+fmt.Sprintf("%#v", this.LocustFileTmpl)+",\n")
	if this.Phases != nil {
...
func (m *LocustConfigFile) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.LocustFileTmpl) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintLoadConfig(dAtA, i, uint64(len(m.LocustFileTmpl)))
		i += copy(dAtA[i:], m.LocustFileTmpl)
	}
	if len(m.Phases) > 0 {
...
func (this *LocustConfigFile) String() string {
	...
	s := strings.Join([]string{`&LocustConfigFile{`,
		`LocustFileTmpl:` + fmt.Sprintf("%v", this.LocustFileTmpl) + `,`,
...
func (m *LocustConfigFile) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocustFileTmpl", wireType)
			}
			...
			m.LocustFileTmpl = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func init() {
	proto.RegisterFile("demos/load_generation/proto/load_config.proto", fileDescriptor_load_config_2443b84c186e4d9d)
}

var fileDescriptor_load_config_2443b84c186e4d9d = []byte{
	// 422 bytes of a gzipped FileDescriptorProto
	,
}
