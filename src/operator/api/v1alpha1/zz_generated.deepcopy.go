...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VizierClient) DeepCopyInto(out *VizierClient) {
	*out = *in
	if in.client != nil {
		in, out := &in.client, &out.client
		*out = new(rest.RESTClient)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VizierClient.
func (in *VizierClient) DeepCopy() *VizierClient {
	if in == nil {
		return nil
	}
	out := new(VizierClient)
	in.DeepCopyInto(out)
	return out
}
