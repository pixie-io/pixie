...
describe('simple stacktraceFlameGraph', () => {
  ...
  it('preprocesses data correctly', () => {
    ...
    expect(processedData).toEqual(expect.arrayContaining([
      ...
      {
        fullPath: 'all;namespace: namespace;pod: pod;container: container;pid: pid',
        name: 'pid: pid',
        count: 7,
      ...
      {
        fullPath: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st1',
        name: 'st1',
        count: 3,
        parent: 'all;namespace: namespace;pod: pod;container: container;pid: pid',
        percentage: 7.7,
        weight: 0,
        color: 'other',
      },
      {
        fullPath: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st1;st2',
        name: 'st2',
        count: 1,
        parent: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st1',
        percentage: 5.5,
        weight: 0,
        color: 'other',
      },
      {
        fullPath: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st1;st2;c::trace',
        name: 'c::trace',
        count: 1,
        parent: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st1;st2',
        percentage: 5.5,
        weight: 1,
        color: 'c',
      },
      {
        fullPath: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st1;st4',
        name: 'st4',
        count: 2,
        parent: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st1',
        percentage: 2.2,
      ...
      {
        fullPath: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st2',
        name: 'st2',
        count: 4,
        parent: 'all;namespace: namespace;pod: pod;container: container;pid: pid',
        percentage: 92.3,
      ...
      {
        fullPath: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st2;st4',
        name: 'st4',
        count: 4,
        parent: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st2',
        percentage: 92.3,
        weight: 1,
        color: 'other',
      },
      {
        fullPath: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st2;st4;golang.(*trace)',
        name: 'golang.(*trace)',
        count: 3,
        parent: 'all;namespace: namespace;pod: pod;container: container;pid: pid;st2;st4',
        percentage: 82.3,
        weight: 3,
        color: 'go',
      },
