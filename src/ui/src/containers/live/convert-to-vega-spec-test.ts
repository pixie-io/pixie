...
describe('simple stacktraceFlameGraph', () => {
  ...
  it('preprocesses data correctly', () => {
    ...
    expect(processedData).toEqual(expect.arrayContaining([
      {
        fullPath: 'all', name: 'all', count: 8, parent: null, weight: 0,
      },
      {
        fullPath: 'all;namespace', name: 'namespace', count: 8, parent: 'all', percentage: 100, weight: 0,
      },
      {
        fullPath: 'all;namespace;pod', name: 'pod', count: 8, parent: 'all;namespace', percentage: 100, weight: 0,
      },
      {
        fullPath: 'all;namespace;pod;container',
        name: 'container',
        count: 8,
        parent: 'all;namespace;pod',
        percentage: 100,
        weight: 0,
      },
      {
        fullPath: 'all;namespace;pod;container;pid',
        name: 'pid',
        count: 7,
        parent: 'all;namespace;pod;container',
        percentage: 100,
        weight: 0,
      },
      {
        fullPath: 'all;namespace;pod;container;pid;st1',
        name: 'st1',
        count: 3,
        parent: 'all;namespace;pod;container;pid',
        percentage: 7.7,
        weight: 0,
      },
      {
        fullPath: 'all;namespace;pod;container;pid;st1;st2',
        name: 'st2',
        count: 1,
        parent: 'all;namespace;pod;container;pid;st1',
        percentage: 5.5,
        weight: 0,
      },
      {
        fullPath: 'all;namespace;pod;container;pid;st1;st2;st3',
        name: 'st3',
        count: 1,
        parent: 'all;namespace;pod;container;pid;st1;st2',
        percentage: 5.5,
        weight: 1,
      },
      {
        fullPath: 'all;namespace;pod;container;pid;st1;st4',
        name: 'st4',
        count: 2,
        parent: 'all;namespace;pod;container;pid;st1',
        percentage: 2.2,
      ...
      {
        fullPath: 'all;namespace;pod;container;pid;st2',
        name: 'st2',
        count: 4,
        parent: 'all;namespace;pod;container;pid',
        percentage: 92.3,
      ...
      {
        fullPath: 'all;namespace;pod;container;pid;st2;st4',
        name: 'st4',
        count: 4,
        parent: 'all;namespace;pod;container;pid;st2',
        percentage: 92.3,
        weight: 1,
      },
      {
        fullPath: 'all;namespace;pod;container;pid;st2;st4;st5',
        name: 'st5',
        count: 3,
        parent: 'all;namespace;pod;container;pid;st2;st4',
        percentage: 82.3,
        weight: 3,
      },
      {
        fullPath: 'all;namespace;pod;container;UNKNOWN',
        name: 'UNKNOWN',
        count: 1,
        parent: 'all;namespace;pod;container',
        percentage: 0,
      ...
      {
        fullPath: 'all;namespace;pod;container;UNKNOWN;st6',
        name: 'st6',
        count: 1,
        parent: 'all;namespace;pod;container;UNKNOWN',
        percentage: 0,
        weight: 1,
      },
    ]));
