...
type VizierSpec struct {
	...
	EnableClockworkIntegration bool              `protobuf:"varint,11,opt,name=enable_clockwork_integration,json=enableClockworkIntegration,proto3" json:"enable_clockwork_integration,omitempty"`
}
...
func (m *VizierSpec) GetEnableClockworkIntegration() bool {
	if m != nil {
		return m.EnableClockworkIntegration
	}
	return false
}
...
var fileDescriptor_5892195818dca4ca = []byte{
	...
	,
}
...
func (this *VizierSpec) Equal(that interface{}) bool {
	...
	if this.EnableClockworkIntegration != that1.EnableClockworkIntegration {
		return false
	}
	return true
}
...
func (this *VizierSpec) GoString() string {
	...
	s = append(s, "EnableClockworkIntegration: "+fmt.Sprintf("%#v", this.EnableClockworkIntegration)+",\n")
	s = append(s, "}")
...
func (m *VizierSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.EnableClockworkIntegration {
		i--
		if m.EnableClockworkIntegration {
			dAtA[i] = 1
		} else {
...
func (this *VizierSpec) String() string {
	...
	s := strings.Join([]string{`&VizierSpec{`,
		...
		`EnableClockworkIntegration:` + fmt.Sprintf("%v", this.EnableClockworkIntegration) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *VizierSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableClockworkIntegration", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableClockworkIntegration = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipVizierTypes(dAtA[iNdEx:])
			if err != nil {
