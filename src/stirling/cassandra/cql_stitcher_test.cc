...
std::string_view kResultMsgStr = CreateStringView<char>(CharArrayStringView<uint8_t>(kResultMsg));
...
std::string_view kBadQueryMsgStr =
    CreateStringView<char>(CharArrayStringView<uint8_t>(kBadQueryMsg));
...
std::string_view kBadQueryErrorMsgStr =
    CreateStringView<char>(CharArrayStringView<uint8_t>(kBadQueryErrorMsg));
