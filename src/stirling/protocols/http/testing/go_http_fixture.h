 ...
 public:
  GoHTTPFixture() {
    constexpr char kClientPath[] =
        "src/stirling/protocols/http/testing/go_http_client/go_http_client_/go_http_client";
    constexpr char kServerPath[] =
        "src/stirling/protocols/http/testing/go_http_server/go_http_server_/go_http_server";
