...
type Probe struct {
	Name       string               `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	TracePoint *sharedpb.TracePoint `protobuf:"bytes,2,opt,name=trace_point,json=tracePoint,proto3" json:"trace_point,omitempty"`
...
type Program struct {
	...
	BinarySpec *sharedpb.BinarySpec `protobuf:"bytes,1,opt,name=binary_spec,json=binarySpec,proto3" json:"binary_spec,omitempty"`
...
func (m *Program) GetBinarySpec() *sharedpb.BinarySpec {
	if m != nil {
		return m.BinarySpec
	}
	return nil
...
func (m *Program) GetMaps() []*sharedpb.Map {
	if m != nil {
		return m.Maps
	}
	return nil
...
var fileDescriptor_5d736283bfb1d17d = []byte{
	...
	,
}
...
func (this *Program) String() string {
	...
	s := strings.Join([]string{`&Program{`,
		`BinarySpec:` + strings.Replace(fmt.Sprintf("%v", this.BinarySpec), "BinarySpec", "sharedpb.BinarySpec", 1) + `,`,
...
func (m *Program) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.BinarySpec == nil {
				m.BinarySpec = &sharedpb.BinarySpec{}
			}
