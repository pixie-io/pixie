...
// source: src/stirling/dynamic_tracing/ir/logicalpb/logical.proto
...
import (
	...
	math "math"
	math_bits "math/bits"
	sharedpb "pixielabs.ai/pixielabs/src/stirling/dynamic_tracing/ir/sharedpb"
	reflect "reflect"
	strings "strings"
)
...
type Constant struct {
	...
	Type     sharedpb.ScalarType `protobuf:"varint,2,opt,name=type,proto3,enum=pl.stirling.dynamic_tracing.ir.shared.ScalarType" json:"type,omitempty"`
...
func (*Constant) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{0}
}
...
func (*Argument) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{1}
}
...
func (*ReturnValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{2}
}
...
type MapValue struct {
	...
	Key      sharedpb.BPFHelper `protobuf:"varint,2,opt,name=key,proto3,enum=pl.stirling.dynamic_tracing.ir.shared.BPFHelper" json:"key,omitempty"`
...
func (*MapValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{3}
}
...
func (*MapStashAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{4}
}
...
func (*MapDeleteAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{5}
}
...
func (*Output) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{6}
}
...
func (*OutputAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{7}
}
...
func (*Probe) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{8}
}
...
type TracepointDeployment struct {
	...
	Bpftrace       *TracepointDeployment_BPFTrace     `protobuf:"bytes,5,opt,name=bpftrace,proto3" json:"bpftrace,omitempty"`
}
...
func (m *TracepointDeployment) GetBpftrace() *TracepointDeployment_BPFTrace {
	if m != nil {
		return m.Bpftrace
	}
	return nil
...
type TracepointDeployment_BPFTrace struct {
	Program string                                  `protobuf:"bytes,1,opt,name=program,proto3" json:"program,omitempty"`
	Outputs []*TracepointDeployment_BPFTrace_Output `protobuf:"bytes,2,rep,name=outputs,proto3" json:"outputs,omitempty"`
}

func (m *TracepointDeployment_BPFTrace) Reset()      { *m = TracepointDeployment_BPFTrace{} }
func (*TracepointDeployment_BPFTrace) ProtoMessage() {}
func (*TracepointDeployment_BPFTrace) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{10, 1}
}
func (m *TracepointDeployment_BPFTrace) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TracepointDeployment_BPFTrace) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TracepointDeployment_BPFTrace.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TracepointDeployment_BPFTrace) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TracepointDeployment_BPFTrace.Merge(m, src)
}
func (m *TracepointDeployment_BPFTrace) XXX_Size() int {
	return m.Size()
}
func (m *TracepointDeployment_BPFTrace) XXX_DiscardUnknown() {
	xxx_messageInfo_TracepointDeployment_BPFTrace.DiscardUnknown(m)
}

var xxx_messageInfo_TracepointDeployment_BPFTrace proto.InternalMessageInfo

func (m *TracepointDeployment_BPFTrace) GetProgram() string {
	if m != nil {
		return m.Program
	}
	return ""
...
func (m *TracepointDeployment_BPFTrace) GetOutputs() []*TracepointDeployment_BPFTrace_Output {
	if m != nil {
		return m.Outputs
	}
	return nil
...
type TracepointDeployment_BPFTrace_Output struct {
	Name string              `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Type sharedpb.ScalarType `protobuf:"varint,2,opt,name=type,proto3,enum=pl.stirling.dynamic_tracing.ir.shared.ScalarType" json:"type,omitempty"`
}

func (m *TracepointDeployment_BPFTrace_Output) Reset()      { *m = TracepointDeployment_BPFTrace_Output{} }
func (*TracepointDeployment_BPFTrace_Output) ProtoMessage() {}
func (*TracepointDeployment_BPFTrace_Output) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d736283bfb1d17d, []int{10, 1, 0}
}
func (m *TracepointDeployment_BPFTrace_Output) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TracepointDeployment_BPFTrace_Output) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TracepointDeployment_BPFTrace_Output.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TracepointDeployment_BPFTrace_Output) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TracepointDeployment_BPFTrace_Output.Merge(m, src)
}
func (m *TracepointDeployment_BPFTrace_Output) XXX_Size() int {
	return m.Size()
}
func (m *TracepointDeployment_BPFTrace_Output) XXX_DiscardUnknown() {
	xxx_messageInfo_TracepointDeployment_BPFTrace_Output.DiscardUnknown(m)
}

var xxx_messageInfo_TracepointDeployment_BPFTrace_Output proto.InternalMessageInfo

func (m *TracepointDeployment_BPFTrace_Output) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *TracepointDeployment_BPFTrace_Output) GetType() sharedpb.ScalarType {
	if m != nil {
		return m.Type
	}
	return sharedpb.UNKNOWN
...
func init() {
	...
	proto.RegisterType((*MapDeleteAction)(nil), "pl.stirling.dynamic_tracing.ir.logical.MapDeleteAction")
	...
	proto.RegisterType((*TracepointDeployment_BPFTrace)(nil), "pl.stirling.dynamic_tracing.ir.logical.TracepointDeployment.BPFTrace")
	proto.RegisterType((*TracepointDeployment_BPFTrace_Output)(nil), "pl.stirling.dynamic_tracing.ir.logical.TracepointDeployment.BPFTrace.Output")
}

func init() {
	proto.RegisterFile("src/stirling/dynamic_tracing/ir/logicalpb/logical.proto", fileDescriptor_5d736283bfb1d17d)
}
...
var fileDescriptor_5d736283bfb1d17d = []byte{
	...
	,
}
...
func (this *TracepointDeployment_BPFTrace) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TracepointDeployment_BPFTrace)
	if !ok {
		that2, ok := that.(TracepointDeployment_BPFTrace)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TracepointDeployment_BPFTrace_Output) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TracepointDeployment_BPFTrace_Output)
	if !ok {
		that2, ok := that.(TracepointDeployment_BPFTrace_Output)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TracepointDeployment_BPFTrace) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&logicalpb.TracepointDeployment_BPFTrace{")
	s = append(s, "Program: "+fmt.Sprintf("%#v", this.Program)+",\n")
	if this.Outputs != nil {
		s = append(s, "Outputs: "+fmt.Sprintf("%#v", this.Outputs)+",\n")
	}
...
func (this *TracepointDeployment_BPFTrace_Output) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&logicalpb.TracepointDeployment_BPFTrace_Output{")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "Type: "+fmt.Sprintf("%#v", this.Type)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
...
func (m *TracepointDeployment_BPFTrace) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TracepointDeployment_BPFTrace) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TracepointDeployment_BPFTrace) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TracepointDeployment_BPFTrace_Output) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TracepointDeployment_BPFTrace_Output) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TracepointDeployment_BPFTrace_Output) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TracepointDeployment_BPFTrace) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TracepointDeployment_BPFTrace_Output) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *TracepointDeployment) String() string {
	...
	s := strings.Join([]string{`&TracepointDeployment{`,
		...
		`Bpftrace:` + strings.Replace(fmt.Sprintf("%v", this.Bpftrace), "TracepointDeployment_BPFTrace", "TracepointDeployment_BPFTrace", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *TracepointDeployment_BPFTrace) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForOutputs := "[]*TracepointDeployment_BPFTrace_Output{"
	for _, f := range this.Outputs {
		repeatedStringForOutputs += strings.Replace(fmt.Sprintf("%v", f), "TracepointDeployment_BPFTrace_Output", "TracepointDeployment_BPFTrace_Output", 1) + ","
	}
	repeatedStringForOutputs += "}"
	s := strings.Join([]string{`&TracepointDeployment_BPFTrace{`,
...
func (this *TracepointDeployment_BPFTrace_Output) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TracepointDeployment_BPFTrace_Output{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Type:` + fmt.Sprintf("%v", this.Type) + `,`,
		`}`,
	}, "")
...
func (m *TracepointDeployment) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Bpftrace == nil {
				m.Bpftrace = &TracepointDeployment_BPFTrace{}
			}
...
func (m *TracepointDeployment_BPFTrace) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			m.Outputs = append(m.Outputs, &TracepointDeployment_BPFTrace_Output{})
			if err := m.Outputs[len(m.Outputs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *TracepointDeployment_BPFTrace_Output) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
