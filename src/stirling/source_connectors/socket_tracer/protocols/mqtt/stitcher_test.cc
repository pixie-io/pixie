...
TEST(MqttStitcherTest, MissingResponse) {
    ...
    Message connect_frame, connack_frame,
            pingreq_frame, pingresp_frame,
            pub1_frame, pub1_pid3_frame, puback_frame, puback_pid3_frame,
            pub2_frame, pub2_pid2_frame, pubrec_frame, pubrec_pid2_frame,
            pubrel_frame, pubrel_pid2_frame, pubcomp_frame, pubcomp_pid2_frame,
            sub_frame, suback_frame,
