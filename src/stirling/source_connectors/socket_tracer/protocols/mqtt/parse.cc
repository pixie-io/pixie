  ...
  while (properties_length > 0) {
    ...
    switch (property_code) {
      case static_cast<uint8_t>(PropertyCode::PayloadFormatIndicator): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint8_t payload_format_indicator,
      ...
      case static_cast<uint8_t>(PropertyCode::MessageExpiryInterval): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint32_t message_expiry_interval,
      ...
      case static_cast<uint8_t>(PropertyCode::ContentType): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view content_type,
      ...
      case static_cast<uint8_t>(PropertyCode::ResponseTopic): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view response_topic,
      ...
      case static_cast<uint8_t>(PropertyCode::CorrelationData): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view correlation_data,
                                            decoder->ExtractString(property_length));
      ...
      case static_cast<uint8_t>(PropertyCode::SessionExpiryInterval): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint32_t session_expiry_interval,
                                            decoder->ExtractBEInt<uint32_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::AssignedClientIdentifier): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view assigned_client_identifier,
                                            decoder->ExtractString(property_length));
      ...
      case static_cast<uint8_t>(PropertyCode::ServerKeepAlive): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t server_keep_alive,
                                            decoder->ExtractBEInt<uint16_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::AuthenticationMethod): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view auth_method,
                                            decoder->ExtractString(property_length));
      ...
      case static_cast<uint8_t>(PropertyCode::AuthenticationData): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view auth_data,
                                            decoder->ExtractString(property_length));
      ...
      case static_cast<uint8_t>(PropertyCode::RequestProblemInformation): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint8_t request_problem_information,
                                            decoder->ExtractBEInt<uint8_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::WillDelayInterval): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint32_t will_delay_interval,
                                            decoder->ExtractBEInt<uint32_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::RequestResponseInformation): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint8_t request_response_information,
                                            decoder->ExtractBEInt<uint8_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::ResponseInformation): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view response_information,
                                            decoder->ExtractString(properties_length));
      ...
      case static_cast<uint8_t>(PropertyCode::ServerReference): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view server_reference,
                                            decoder->ExtractString(property_length));
      ...
      case static_cast<uint8_t>(PropertyCode::ReasonString): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t property_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view reason_string,
                                            decoder->ExtractString(property_length));
      ...
      case static_cast<uint8_t>(PropertyCode::ReceiveMaximum): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t receive_maximum,
                                            decoder->ExtractBEInt<uint16_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::TopicAliasMaximum): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t topic_alias_maximum,
                                            decoder->ExtractBEInt<uint16_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::TopicAlias): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t topic_alias,
                                            decoder->ExtractBEInt<uint16_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::RetainAvailable): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint8_t retain_available,
                                            decoder->ExtractBEInt<uint8_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::UserProperty): {
        ...
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view key,
                                            decoder->ExtractString(key_length));
        properties_length -= key_length;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t value_length,
                                            decoder->ExtractBEInt<uint16_t>());
        properties_length -= 2;
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view value,
                                            decoder->ExtractString(value_length));
      ...
      case static_cast<uint8_t>(PropertyCode::MaximumPacketSize): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint32_t maximum_packet_size,
                                            decoder->ExtractBEInt<uint32_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::WildcardSubscriptionAvailable): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint8_t wildcard_subscription_available,
                                            decoder->ExtractBEInt<uint8_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::SubscriptionIdentifiersAvailable): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint8_t subscription_id_available,
                                            decoder->ExtractBEInt<uint8_t>());
      ...
      case static_cast<uint8_t>(PropertyCode::SharedSubscriptionAvailable): {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint8_t shared_subscription_available,
                                            decoder->ExtractBEInt<uint8_t>());
        result->properties["subscription_id_available"] =
...
ParseState ParseVariableHeader(Message* result, BinaryDecoder* decoder,
  ...
  switch (control_packet_type) {
    case MqttControlPacketType::CONNECT: {
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t protocol_name_length,
                                          decoder->ExtractBEInt<uint16_t>());
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view protocol_name,
                                          decoder->ExtractString(protocol_name_length));
      CTX_DCHECK(protocol_name == "MQTT");
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint8_t protocol_version,
                                          decoder->ExtractBEInt<uint8_t>());
      ...
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(result->header_fields["keep_alive"],
                                          decoder->ExtractBEInt<uint16_t>());
    ...
    case MqttControlPacketType::CONNACK: {
      ...
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(result->header_fields["reason_code"],
                                          decoder->ExtractBEInt<uint8_t>());
    ...
    case MqttControlPacketType::PUBLISH: {
      ...
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view topic_name,
      ...
      if (result->header_fields["qos"] != 0) {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(result->header_fields["packet_identifier"],
                                            decoder->ExtractBEInt<uint16_t>());
...
ParseState ParsePayload(Message* result, BinaryDecoder* decoder,
  ...
  switch (control_packet_type) {
    case MqttControlPacketType::CONNECT: {
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(uint16_t client_id_length,
                                          decoder->ExtractBEInt<uint16_t>());
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view client_id,
      ...
      if (result->header_fields["will_flag"]) {
        ...
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view will_topic,
        ...
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view will_payload,
      ...
      if (result->header_fields["username_flag"]) {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(size_t username_length,
                                            decoder->ExtractBEInt<uint16_t>());
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view username,
                                            decoder->ExtractString(username_length));
        result->payload["username"] = std::string(username);
      }

      if (result->header_fields["password_flag"]) {
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(size_t password_length,
                                            decoder->ExtractBEInt<uint16_t>());
    ...
    case MqttControlPacketType::PUBLISH: {
      ...
      PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view payload,
                                          decoder->ExtractString(payload_length));
    ...
    case MqttControlPacketType::SUBSCRIBE: {
      ...
      while (payload_length > 0) {
        ...
        PX_ASSIGN_OR_RETURN_NEEDS_MORE_DATA(std::string_view topic_filter,
...
ParseState ParseFrame(message_type_t type, std::string_view* buf, Message* result) {
  ...
  ParseState parse_variable_header_state =
      ParseVariableHeader(result, &decoder, control_packet_type);
  ParseState parse_payload_state = ParsePayload(result, &decoder, control_packet_type);

  if ((parse_variable_header_state == ParseState::kInvalid) ||
      (parse_variable_header_state == ParseState::kNeedsMoreData)) {
    return parse_variable_header_state;
  }

  if ((parse_payload_state == ParseState::kInvalid) ||
      (parse_payload_state == ParseState::kNeedsMoreData)) {
