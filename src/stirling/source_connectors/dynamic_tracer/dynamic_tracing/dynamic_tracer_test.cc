...
const std::vector<std::string> kExpectedBCC = {
    ...
    "  struct struct_blob64 arg0;",
    "  struct struct_blob64 arg1;",
    "  int arg2;",
    "  uint64_t time_;",
    ...
    "  uint64_t time_;",
    "  struct struct_blob64 f1;",
    "  struct struct_blob64 f2;",
    "  int f3;",
    "  struct struct_blob64 f4;",
    "  int64_t latency;",
    "} __attribute__((packed, aligned(1)));",
    ...
    "uint64_t parm___[6];parm___[0] = ctx->di;parm___[1] = ctx->si;parm___[2] = ctx->dx;parm___[3] "
    "= ctx->cx;parm___[4] = ctx->r8;parm___[5] = ctx->r9;void* parm__ = &parm___;",
    "struct struct_blob64 arg0 = {};",
    "arg0.len = 12;",
    "arg0.decoder_idx = 0;",
    "bpf_probe_read(&arg0.buf, 12, parm__ + 8);",
    "struct struct_blob64 arg1 = {};",
    "arg1.len = 24;",
    "arg1.decoder_idx = 0;",
    "bpf_probe_read(&arg1.buf, 24, sp_ + 8);",
    "int arg2;",
    "bpf_probe_read(&arg2, sizeof(int), parm__ + 24);",
    ...
    "probe0_argstash.update(&tgid_pid_, &probe0_argstash_value);",
    "return 0;",
    "}",
    ...
    "uint64_t tgid_start_time_ = pl_tgid_start_time();",
    "uint64_t time_ = bpf_ktime_get_ns();",
    "void* rc_ = (void*)PT_REGS_RC(ctx);",
    "uint64_t rc___[2];rc___[0] = ctx->ax;rc___[1] = ctx->dx;void* rc__ = &rc___;",
    "struct struct_blob64 retval0 = {};",
    "retval0.len = 24;",
    "retval0.decoder_idx = 0;",
    "bpf_probe_read(&retval0.buf, 24, rc_ + 0);",
    "struct probe0_argstash_value_t* probe0_argstash_ptr = probe0_argstash.lookup(&tgid_pid_);",
    "if (probe0_argstash_ptr == NULL) { return 0; }",
    "struct struct_blob64 arg0 = probe0_argstash_ptr->arg0;",
    "if (probe0_argstash_ptr == NULL) { return 0; }",
    "struct struct_blob64 arg1 = probe0_argstash_ptr->arg1;",
    "if (probe0_argstash_ptr == NULL) { return 0; }",
    "int arg2 = probe0_argstash_ptr->arg2;",
    "if (probe0_argstash_ptr == NULL) { return 0; }",
    "uint64_t start_ktime_ns = probe0_argstash_ptr->time_;",
    "int64_t latency = time_ - start_ktime_ns;",
    "probe0_argstash.delete(&tgid_pid_);",
...
TEST(DynamicTracerTest, Compile) {
  ...
  ASSERT_THAT(bcc_program.uprobe_specs, SizeIs(2));

  const auto& spec = bcc_program.uprobe_specs[0];

  EXPECT_THAT(spec, Field(&UProbeSpec::binary_path, ::testing::EndsWith("cc/test_exe/test_exe")));
  EXPECT_THAT(spec, Field(&UProbeSpec::symbol, "ABCSumMixed"));
  EXPECT_THAT(spec, Field(&UProbeSpec::attach_type, bpf_tools::BPFProbeAttachType::kEntry));
  EXPECT_THAT(spec, Field(&UProbeSpec::probe_fn, "probe0_entry"));
