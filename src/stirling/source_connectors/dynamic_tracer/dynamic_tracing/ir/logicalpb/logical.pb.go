...
type BPFTrace_Output struct {
	Name string           `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Type typespb.DataType `protobuf:"varint,2,opt,name=type,proto3,enum=pl.types.DataType" json:"type,omitempty"`
}
...
func (m *BPFTrace_Output) GetType() typespb.DataType {
	if m != nil {
		return m.Type
	}
...
var fileDescriptor_f7e5876dffcc11b4 = []byte{
	...
	,
}
