...
// source: src/stirling/dynamic_tracer/dynamic_tracing/ir/logicalpb/logical.proto
...
import (
	...
	sharedpb "pixielabs.ai/pixielabs/src/stirling/dynamic_tracer/dynamic_tracing/ir/sharedpb"
	reflect "reflect"
	strings "strings"
)
...
func (*Constant) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{0}
}
...
func (*Argument) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{1}
}
...
func (*ReturnValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{2}
}
...
func (*MapValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{3}
}
...
func (*MapStashAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{4}
}
...
func (*MapDeleteAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{5}
}
...
func (*Output) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{6}
}
...
func (*OutputAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{7}
}
...
func (*Probe) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{8}
}
...
func (*TracepointSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{9}
}
...
type BPFTrace struct {
	...
	Outputs []*BPFTrace_Output `protobuf:"bytes,2,rep,name=outputs,proto3" json:"outputs,omitempty"`
}

func (m *BPFTrace) Reset()      { *m = BPFTrace{} }
func (*BPFTrace) ProtoMessage() {}
func (*BPFTrace) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{10}
}
...
func (m *BPFTrace) GetOutputs() []*BPFTrace_Output {
	if m != nil {
		return m.Outputs
	}
	return nil
...
type BPFTrace_Output struct {
	Name string          `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Type proto1.DataType `protobuf:"varint,2,opt,name=type,proto3,enum=pl.types.DataType" json:"type,omitempty"`
}

func (m *BPFTrace_Output) Reset()      { *m = BPFTrace_Output{} }
func (*BPFTrace_Output) ProtoMessage() {}
func (*BPFTrace_Output) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{10, 0}
}
func (m *BPFTrace_Output) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BPFTrace_Output) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BPFTrace_Output.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BPFTrace_Output) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BPFTrace_Output.Merge(m, src)
}
func (m *BPFTrace_Output) XXX_Size() int {
	return m.Size()
}
func (m *BPFTrace_Output) XXX_DiscardUnknown() {
	xxx_messageInfo_BPFTrace_Output.DiscardUnknown(m)
}

var xxx_messageInfo_BPFTrace_Output proto.InternalMessageInfo

func (m *BPFTrace_Output) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *BPFTrace_Output) GetType() proto1.DataType {
	if m != nil {
		return m.Type
	}
...
func (*TracepointDeployment) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{11}
}
...
func (*TracepointDeployment_Tracepoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_fc7db47d0bf16ecf, []int{11, 0}
}
...
func init() {
	...
	proto.RegisterType((*BPFTrace)(nil), "pl.stirling.dynamic_tracing.ir.logical.BPFTrace")
	proto.RegisterType((*BPFTrace_Output)(nil), "pl.stirling.dynamic_tracing.ir.logical.BPFTrace.Output")
...
func init() {
	proto.RegisterFile("src/stirling/dynamic_tracer/dynamic_tracing/ir/logicalpb/logical.proto", fileDescriptor_fc7db47d0bf16ecf)
}

var fileDescriptor_fc7db47d0bf16ecf = []byte{
	...
	,
}
...
func (this *BPFTrace_Output) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*BPFTrace_Output)
	if !ok {
		that2, ok := that.(BPFTrace_Output)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *BPFTrace_Output) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&logicalpb.BPFTrace_Output{")
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "Type: "+fmt.Sprintf("%#v", this.Type)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
...
func (m *BPFTrace_Output) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BPFTrace_Output) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BPFTrace_Output) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BPFTrace_Output) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *BPFTrace) String() string {
	...
	repeatedStringForOutputs := "[]*BPFTrace_Output{"
	for _, f := range this.Outputs {
		repeatedStringForOutputs += strings.Replace(fmt.Sprintf("%v", f), "BPFTrace_Output", "BPFTrace_Output", 1) + ","
	}
	repeatedStringForOutputs += "}"
...
func (this *BPFTrace_Output) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&BPFTrace_Output{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`Type:` + fmt.Sprintf("%v", this.Type) + `,`,
		`}`,
	}, "")
...
func (m *BPFTrace) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Outputs = append(m.Outputs, &BPFTrace_Output{})
			if err := m.Outputs[len(m.Outputs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *BPFTrace_Output) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
