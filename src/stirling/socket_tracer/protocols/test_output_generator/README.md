...
mysql_tshark.sh
```
Output is in `src/stirling/socket_tracer/protocols/mysql/testing/tshark.json`
...
```
bazel run //src/stirling/socket_tracer/protocols/test_output_generator:test_generator \
-- src/stirling/socket_tracer/protocols/mysql/testing/tshark.json \
