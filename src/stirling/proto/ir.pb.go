...
type ValueType_Scaler struct {
	Scaler ScalarType `protobuf:"varint,2,opt,name=scaler,proto3,enum=pl.stirling.dynamictracingpb.ScalarType,oneof" json:"scaler,omitempty"`
}
type ValueType_Struct struct {
	Struct string `protobuf:"bytes,3,opt,name=struct,proto3,oneof" json:"struct,omitempty"`
}

func (*ValueType_Scaler) isValueType_TypeOneof() {}
func (*ValueType_Struct) isValueType_TypeOneof() {}
...
func (m *ValueType) GetScaler() ScalarType {
	if x, ok := m.GetTypeOneof().(*ValueType_Scaler); ok {
		return x.Scaler
	}
	return INT32
}

func (m *ValueType) GetStruct() string {
	if x, ok := m.GetTypeOneof().(*ValueType_Struct); ok {
		return x.Struct
	}
	return ""
}
...
func (*ValueType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ValueType_Scaler)(nil),
		(*ValueType_Struct)(nil),
	}
}
...
var fileDescriptor_7def418e304cd30c = []byte{
	...
	,
}
...
func (this *ValueType_Scaler) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ValueType_Scaler)
	if !ok {
		that2, ok := that.(ValueType_Scaler)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.Scaler != that1.Scaler {
		return false
	}
	return true
}
func (this *ValueType_Struct) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ValueType_Struct)
	if !ok {
		that2, ok := that.(ValueType_Struct)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ValueType_Scaler) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dynamictracingpb.ValueType_Scaler{` +
		`Scaler:` + fmt.Sprintf("%#v", this.Scaler) + `}`}, ", ")
	return s
}
func (this *ValueType_Struct) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&dynamictracingpb.ValueType_Struct{` +
...
func (m *ValueType_Scaler) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValueType_Scaler) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintIr(dAtA, i, uint64(m.Scaler))
	i--
	dAtA[i] = 0x10
	return len(dAtA) - i, nil
}
func (m *ValueType_Struct) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ValueType_Struct) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Struct)
	copy(dAtA[i:], m.Struct)
	i = encodeVarintIr(dAtA, i, uint64(len(m.Struct)))
	i--
	dAtA[i] = 0x1a
	return len(dAtA) - i, nil
}
...
func (m *ValueType_Scaler) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovIr(uint64(m.Scaler))
	return n
}
func (m *ValueType_Struct) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ValueType_Scaler) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ValueType_Scaler{`,
		`Scaler:` + fmt.Sprintf("%v", this.Scaler) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ValueType_Struct) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ValueType_Struct{`,
		`Struct:` + fmt.Sprintf("%v", this.Struct) + `,`,
		`}`,
	}, "")
	return s
...
func (m *ValueType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TypeOneof = &ValueType_Scaler{v}
		case 3:
			if wireType != 2 {
			...
			m.TypeOneof = &ValueType_Struct{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
