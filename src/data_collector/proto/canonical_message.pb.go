...
func (*Canonical) Descriptor() ([]byte, []int) {
	return fileDescriptor_canonical_message_844a60fe0cc39d3a, []int{0}
}
...
func (*CanonicalRepeatedColumn) Descriptor() ([]byte, []int) {
	return fileDescriptor_canonical_message_844a60fe0cc39d3a, []int{1}
}
...
func (*CanonicalStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_canonical_message_844a60fe0cc39d3a, []int{2}
}
...
func init() {
	proto.RegisterType((*Canonical)(nil), "pl.datacollector.datacollectorpb.Canonical")
	proto.RegisterType((*CanonicalRepeatedColumn)(nil), "pl.datacollector.datacollectorpb.CanonicalRepeatedColumn")
	proto.RegisterType((*CanonicalStream)(nil), "pl.datacollector.datacollectorpb.CanonicalStream")
}
...
func (this *Canonical) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&datacollectorpb.Canonical{")
...
func (this *CanonicalRepeatedColumn) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&datacollectorpb.CanonicalRepeatedColumn{")
	s = append(s, "TimeStamp: "+fmt.Sprintf("%#v", this.TimeStamp)+",\n")
	s = append(s, "Data1: "+fmt.Sprintf("%#v", this.Data1)+",\n")
	s = append(s, "Data2: "+fmt.Sprintf("%#v", this.Data2)+",\n")
	s = append(s, "}")
...
func (this *CanonicalStream) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&datacollectorpb.CanonicalStream{")
...
func init() {
	proto.RegisterFile("src/data_collector/proto/canonical_message.proto", fileDescriptor_canonical_message_844a60fe0cc39d3a)
}

var fileDescriptor_canonical_message_844a60fe0cc39d3a = []byte{
	...
	,
	...
	0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0x88, 0xe2, 0x47, 0x33, 0x34, 0x89, 0x0d, 0x1c, 0x0d, 0xc6,
	0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x05, 0xfa, 0x96, 0x9c, 0xba, 0x01, 0x00, 0x00,
}
