...
class PubSubManager {
 public:
   ...
   *
   * @return datacollectorpb::PubSub Initial publish message to be sent to agent
   */
  datacollectorpb::Publish GeneratePublishProto();
   ...
   * @return Status
   */
  Status UpdateSchemaFromSubscribe(const datacollectorpb::Subscribe& subscribe_proto);
