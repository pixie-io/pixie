...
func (*UUID) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc3697897a52ef42, []int{0}
}
...
func init() { proto.RegisterFile("src/common/uuid/proto/uuid.proto", fileDescriptor_dc3697897a52ef42) }

var fileDescriptor_dc3697897a52ef42 = []byte{
