...
package auth // import "pixielabs.ai/pixielabs/src/services/auth/proto"

import proto "github.com/gogo/protobuf/proto"
import fmt "fmt"
import math "math"
import _ "github.com/gogo/protobuf/gogoproto"
import proto1 "pixielabs.ai/pixielabs/src/services/common/proto"
...
func (*LoginRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_5fb472a01a379859, []int{0}
}
...
func (*LoginReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_5fb472a01a379859, []int{1}
}
...
func (*GetAugmentedAuthTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_5fb472a01a379859, []int{2}
}
...
func (*GetAugmentedAuthTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_auth_5fb472a01a379859, []int{3}
}
...
func init() {
	proto.RegisterFile("src/services/auth/proto/auth.proto", fileDescriptor_auth_5fb472a01a379859)
}

var fileDescriptor_auth_5fb472a01a379859 = []byte{
	// 392 bytes of a gzipped FileDescriptorProto
	,
}
