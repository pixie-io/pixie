...
type VizierMessage struct {
	...
	//	*VizierMessage_EvictProbeRequest
...
type VizierMessage_EvictProbeRequest struct {
	EvictProbeRequest *EvictProbeRequest `protobuf:"bytes,12,opt,name=evict_probe_request,json=evictProbeRequest,proto3,oneof" json:"evict_probe_request,omitempty"`
}
...
func (*VizierMessage_EvictProbeRequest) isVizierMessage_Msg()     {}
...
func (m *VizierMessage) GetEvictProbeRequest() *EvictProbeRequest {
	if x, ok := m.GetMsg().(*VizierMessage_EvictProbeRequest); ok {
...
func (*VizierMessage) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*VizierMessage_EvictProbeRequest)(nil),
	}
}
...
var fileDescriptor_0046fd1b9991f89c = []byte{
	...
	,
}
...
func (this *VizierMessage_EvictProbeRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*VizierMessage_EvictProbeRequest)
	if !ok {
		that2, ok := that.(VizierMessage_EvictProbeRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *VizierMessage_EvictProbeRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&messages.VizierMessage_EvictProbeRequest{` +
...
func (m *VizierMessage_EvictProbeRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VizierMessage_EvictProbeRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *VizierMessage_EvictProbeRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *VizierMessage_EvictProbeRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&VizierMessage_EvictProbeRequest{`,
...
func (m *VizierMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			...
			m.Msg = &VizierMessage_EvictProbeRequest{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
