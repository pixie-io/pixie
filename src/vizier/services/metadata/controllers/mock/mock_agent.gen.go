...
func (m *MockAgentManager) AddToUpdateQueue(arg0 uuid.UUID, arg1 *messages.AgentUpdateInfo) {
	m.ctrl.T.Helper()
...
func (m *MockAgentManager) GetMetadataUpdates(hostname string) ([]*pl_shared_k8s_metadatapb.ResourceUpdate, error) {
	m.ctrl.T.Helper()
