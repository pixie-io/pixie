...
package pl_vizier_services_shared_agent
...
type AgentStatus struct {
	...
	State                AgentState `protobuf:"varint,2,opt,name=state,proto3,enum=pl.vizier.services.shared.agent.AgentState" json:"state,omitempty"`
}
...
func init() {
	proto.RegisterEnum("pl.vizier.services.shared.agent.AgentState", AgentState_name, AgentState_value)
	proto.RegisterType((*AgentCapabilities)(nil), "pl.vizier.services.shared.agent.AgentCapabilities")
	proto.RegisterType((*AgentInfo)(nil), "pl.vizier.services.shared.agent.AgentInfo")
	proto.RegisterType((*HostInfo)(nil), "pl.vizier.services.shared.agent.HostInfo")
	proto.RegisterType((*Agent)(nil), "pl.vizier.services.shared.agent.Agent")
	proto.RegisterType((*AgentStatus)(nil), "pl.vizier.services.shared.agent.AgentStatus")
}
...
var fileDescriptor_fef0af3bd5248f34 = []byte{
	...
	,
}
...
func (this *AgentCapabilities) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&pl_vizier_services_shared_agent.AgentCapabilities{")
...
func (this *AgentInfo) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&pl_vizier_services_shared_agent.AgentInfo{")
	if this.AgentID != nil {
...
func (this *HostInfo) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&pl_vizier_services_shared_agent.HostInfo{")
...
func (this *Agent) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&pl_vizier_services_shared_agent.Agent{")
	if this.Info != nil {
...
func (this *AgentStatus) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&pl_vizier_services_shared_agent.AgentStatus{")
