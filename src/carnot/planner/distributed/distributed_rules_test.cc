...
TEST_F(DistributedRulesTest, LimitPushdownRule_simple_no_op) {
...
TEST_F(DistributedRulesTest, LimitPushdownRule_simple) {
  Relation relation({types::DataType::INT64, types::DataType::INT64}, {"abc", "xyz"});
...
TEST_F(DistributedRulesTest, LimitPushdownRule_pem_only) {
...
TEST_F(DistributedRulesTest, LimitPushdownRule_multi_branch_union) {
  Relation relation1({types::DataType::INT64, types::DataType::INT64}, {"abc", "xyz"});
  Relation relation2({types::DataType::INT64}, {"abc"});
