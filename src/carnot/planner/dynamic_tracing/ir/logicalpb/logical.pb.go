...
func (*TracepointDeployment_TracepointProgram) Descriptor() ([]byte, []int) {
	return fileDescriptor_8cf202d4a324913e, []int{11, 0}
}
...
func init() {
	proto.RegisterType((*Argument)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.Argument")
	proto.RegisterType((*ReturnValue)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.ReturnValue")
	proto.RegisterType((*Output)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.Output")
	proto.RegisterType((*OutputAction)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.OutputAction")
	proto.RegisterType((*Tracepoint)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.Tracepoint")
	proto.RegisterType((*FunctionLatency)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.FunctionLatency")
	proto.RegisterType((*Probe)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.Probe")
	proto.RegisterType((*TracepointSpec)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.TracepointSpec")
	proto.RegisterType((*BPFTrace)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.BPFTrace")
	proto.RegisterType((*UPID)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.UPID")
	proto.RegisterType((*DeploymentSpec)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.DeploymentSpec")
	proto.RegisterType((*DeploymentSpec_SharedObject)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.DeploymentSpec.SharedObject")
	proto.RegisterType((*DeploymentSpec_PodProcess)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.DeploymentSpec.PodProcess")
	proto.RegisterType((*TracepointDeployment)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.TracepointDeployment")
	proto.RegisterType((*TracepointDeployment_TracepointProgram)(nil), "pl.carnot.planner.dynamic_tracing.ir.logical.TracepointDeployment.TracepointProgram")
}
...
var fileDescriptor_8cf202d4a324913e = []byte{
	...
	,
}
...
func (m *DeploymentSpec_PodProcess) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Pod) > 0 {
		i -= len(m.Pod)
		copy(dAtA[i:], m.Pod)
		i = encodeVarintLogical(dAtA, i, uint64(len(m.Pod)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
