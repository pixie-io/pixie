...
// source: src/carnot/compiler/plannerpb/query_flags.proto
...
func init() {
	proto.RegisterFile("src/carnot/compiler/plannerpb/query_flags.proto", fileDescriptor_786c9517dae463d8)
}
