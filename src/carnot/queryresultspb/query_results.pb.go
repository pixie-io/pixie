...
type QueryResult struct {
	Tables              []*schemapb.Table      `protobuf:"bytes,1,rep,name=tables,proto3" json:"tables,omitempty"`
...
func (m *QueryResult) GetTables() []*schemapb.Table {
	if m != nil {
		return m.Tables
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryResult)(nil), "px.carnot.queryresultspb.QueryResult")
}
...
var fileDescriptor_9ab3e12aa52e3568 = []byte{
	...
	,
}
...
func (this *QueryResult) String() string {
	...
	for _, f := range this.Tables {
		repeatedStringForTables += strings.Replace(fmt.Sprintf("%v", f), "Table", "schemapb.Table", 1) + ","
	}
...
func (m *QueryResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Tables = append(m.Tables, &schemapb.Table{})
