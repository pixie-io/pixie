...
type UDASpec struct {
	...
	InitArgTypes    []typespb.DataType `protobuf:"varint,2,rep,packed,name=init_arg_types,json=initArgTypes,proto3,enum=pl.types.DataType" json:"init_arg_types,omitempty"`
	UpdateArgTypes  []typespb.DataType `protobuf:"varint,3,rep,packed,name=update_arg_types,json=updateArgTypes,proto3,enum=pl.types.DataType" json:"update_arg_types,omitempty"`
	FinalizeType    typespb.DataType   `protobuf:"varint,4,opt,name=finalize_type,json=finalizeType,proto3,enum=pl.types.DataType" json:"finalize_type,omitempty"`
...
type ScalarUDFSpec struct {
	Name         string             `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	InitArgTypes []typespb.DataType `protobuf:"varint,2,rep,packed,name=init_arg_types,json=initArgTypes,proto3,enum=pl.types.DataType" json:"init_arg_types,omitempty"`
	ExecArgTypes []typespb.DataType `protobuf:"varint,3,rep,packed,name=exec_arg_types,json=execArgTypes,proto3,enum=pl.types.DataType" json:"exec_arg_types,omitempty"`
	ReturnType   typespb.DataType   `protobuf:"varint,4,opt,name=return_type,json=returnType,proto3,enum=pl.types.DataType" json:"return_type,omitempty"`
	Executor     UDFSourceExecutor  `protobuf:"varint,5,opt,name=executor,proto3,enum=pl.carnot.udfspb.UDFSourceExecutor" json:"executor,omitempty"`
}
...
type UDTFSourceSpec_Arg struct {
	Name         string               `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	ArgType      typespb.DataType     `protobuf:"varint,2,opt,name=arg_type,json=argType,proto3,enum=pl.types.DataType" json:"arg_type,omitempty"`
	SemanticType typespb.SemanticType `protobuf:"varint,3,opt,name=semantic_type,json=semanticType,proto3,enum=pl.types.SemanticType" json:"semantic_type,omitempty"`
...
type SemanticInferenceRule struct {
	...
	InitArgTypes   []typespb.SemanticType `protobuf:"varint,3,rep,packed,name=init_arg_types,json=initArgTypes,proto3,enum=pl.types.SemanticType" json:"init_arg_types,omitempty"`
	UpdateArgTypes []typespb.SemanticType `protobuf:"varint,4,rep,packed,name=update_arg_types,json=updateArgTypes,proto3,enum=pl.types.SemanticType" json:"update_arg_types,omitempty"`
	ExecArgTypes   []typespb.SemanticType `protobuf:"varint,5,rep,packed,name=exec_arg_types,json=execArgTypes,proto3,enum=pl.types.SemanticType" json:"exec_arg_types,omitempty"`
	OutputType     typespb.SemanticType   `protobuf:"varint,6,opt,name=output_type,json=outputType,proto3,enum=pl.types.SemanticType" json:"output_type,omitempty"`
}
...
type IdentDoc struct {
	...
	Type  typespb.DataType `protobuf:"varint,3,opt,name=type,proto3,enum=pl.types.DataType" json:"type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("pl.carnot.udfspb.UDFSourceExecutor", UDFSourceExecutor_name, UDFSourceExecutor_value)
...
var fileDescriptor_870a8b723557d52e = []byte{
	...
	,
}
