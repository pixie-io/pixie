...
import (
	...
	bccinfo "pixielabs.ai/pixielabs/src/platform_dependent/smoke_test/bccinfo"
	generatesysteminfo "pixielabs.ai/pixielabs/src/platform_dependent/smoke_test/generate_system_info"
	systemchecks "pixielabs.ai/pixielabs/src/platform_dependent/smoke_test/system_checks"
)

// PixieCmd is a cobra CLI utility to run smoke_tests on client machines to determine validity for agents.
var (
	...
	PixieCmd = &cobra.Command{
		Use:     "smoke_test",
		Version: `0.1`,
		Short:   "smoke_test is a utility to validate compute environment to run pixie agents",
...
func init() {
	PixieCmd.SetVersionTemplate("Pixie smoke_test cli version: {{.Version}}\n")
