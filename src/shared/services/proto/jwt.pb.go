...
// source: src/services/services/proto/jwt.proto
...
func init() {
	proto.RegisterType((*JWTClaims)(nil), "pl.services.JWTClaims")
}

func init() {
	proto.RegisterFile("src/services/services/proto/jwt.proto", fileDescriptor_de7d844e43549924)
}
