...
import (
	...
	vizierpb1 "px.dev/pixie/src/vizier/vizierpb"
	reflect "reflect"
	strconv "strconv"
	strings "strings"
)
...
type C2VAPIStreamRequest_DebugLogReq struct {
	DebugLogReq *vizierpb1.DebugLogRequest `protobuf:"bytes,6,opt,name=debug_log_req,json=debugLogReq,proto3,oneof" json:"debug_log_req,omitempty"`
}
type C2VAPIStreamRequest_DebugPodsReq struct {
	DebugPodsReq *vizierpb1.DebugPodsRequest `protobuf:"bytes,7,opt,name=debug_pods_req,json=debugPodsReq,proto3,oneof" json:"debug_pods_req,omitempty"`
}
...
func (m *C2VAPIStreamRequest) GetDebugLogReq() *vizierpb1.DebugLogRequest {
...
func (m *C2VAPIStreamRequest) GetDebugPodsReq() *vizierpb1.DebugPodsRequest {
...
type V2CAPIStreamResponse_DebugLogResp struct {
	DebugLogResp *vizierpb1.DebugLogResponse `protobuf:"bytes,5,opt,name=debug_log_resp,json=debugLogResp,proto3,oneof" json:"debug_log_resp,omitempty"`
}
type V2CAPIStreamResponse_DebugPodsResp struct {
	DebugPodsResp *vizierpb1.DebugPodsResponse `protobuf:"bytes,6,opt,name=debug_pods_resp,json=debugPodsResp,proto3,oneof" json:"debug_pods_resp,omitempty"`
}
...
func (m *V2CAPIStreamResponse) GetDebugLogResp() *vizierpb1.DebugLogResponse {
...
func (m *V2CAPIStreamResponse) GetDebugPodsResp() *vizierpb1.DebugPodsResponse {
...
var fileDescriptor_5a48c2306678667b = []byte{
	...
	0x2b, 0xb4, 0x6c, 0x81, 0x23, 0xc6, 0x33, 0x91, 0x39, 0xb6, 0x13, 0x7c, 0xc9, 0x80, 0x45, 0x83,
	...
	,
}
...
func (this *C2VAPIStreamRequest_DebugLogReq) String() string {
	...
	s := strings.Join([]string{`&C2VAPIStreamRequest_DebugLogReq{`,
		`DebugLogReq:` + strings.Replace(fmt.Sprintf("%v", this.DebugLogReq), "DebugLogRequest", "vizierpb1.DebugLogRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *C2VAPIStreamRequest_DebugPodsReq) String() string {
	...
	s := strings.Join([]string{`&C2VAPIStreamRequest_DebugPodsReq{`,
		`DebugPodsReq:` + strings.Replace(fmt.Sprintf("%v", this.DebugPodsReq), "DebugPodsRequest", "vizierpb1.DebugPodsRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *V2CAPIStreamResponse_DebugLogResp) String() string {
	...
	s := strings.Join([]string{`&V2CAPIStreamResponse_DebugLogResp{`,
		`DebugLogResp:` + strings.Replace(fmt.Sprintf("%v", this.DebugLogResp), "DebugLogResponse", "vizierpb1.DebugLogResponse", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *V2CAPIStreamResponse_DebugPodsResp) String() string {
	...
	s := strings.Join([]string{`&V2CAPIStreamResponse_DebugPodsResp{`,
		`DebugPodsResp:` + strings.Replace(fmt.Sprintf("%v", this.DebugPodsResp), "DebugPodsResponse", "vizierpb1.DebugPodsResponse", 1) + `,`,
		`}`,
	}, "")
	return s
}
