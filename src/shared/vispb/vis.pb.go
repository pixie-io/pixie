...
type BarChart_Bar struct {
	...
	Bin     bool   `protobuf:"varint,5,opt,name=bin,proto3" json:"bin,omitempty"`
}
...
func (m *BarChart_Bar) GetBin() bool {
	if m != nil {
		return m.Bin
	}
	return false
...
var fileDescriptor_afbb78807ac88c00 = []byte{
	...
	,
}
...
func (this *BarChart_Bar) GoString() string {
	...
	s = append(s, "Bin: "+fmt.Sprintf("%#v", this.Bin)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
