...
type Table_LatencyBoxPlot struct {
	P50Column float32 `protobuf:"fixed32,1,opt,name=p50_column,json=p50Column,proto3" json:"p50_column,omitempty"`
	P90Column float32 `protobuf:"fixed32,2,opt,name=p90_column,json=p90Column,proto3" json:"p90_column,omitempty"`
	P99Column float32 `protobuf:"fixed32,3,opt,name=p99_column,json=p99Column,proto3" json:"p99_column,omitempty"`
}

func (m *Table_LatencyBoxPlot) Reset()      { *m = Table_LatencyBoxPlot{} }
func (*Table_LatencyBoxPlot) ProtoMessage() {}
func (*Table_LatencyBoxPlot) Descriptor() ([]byte, []int) {
	return fileDescriptor_afbb78807ac88c00, []int{6, 0}
}
func (m *Table_LatencyBoxPlot) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Table_LatencyBoxPlot) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Table_LatencyBoxPlot.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Table_LatencyBoxPlot) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Table_LatencyBoxPlot.Merge(m, src)
}
func (m *Table_LatencyBoxPlot) XXX_Size() int {
	return m.Size()
}
func (m *Table_LatencyBoxPlot) XXX_DiscardUnknown() {
	xxx_messageInfo_Table_LatencyBoxPlot.DiscardUnknown(m)
}

var xxx_messageInfo_Table_LatencyBoxPlot proto.InternalMessageInfo

func (m *Table_LatencyBoxPlot) GetP50Column() float32 {
	if m != nil {
		return m.P50Column
	}
	return 0
...
func (m *Table_LatencyBoxPlot) GetP90Column() float32 {
	if m != nil {
		return m.P90Column
	}
	return 0
...
func (m *Table_LatencyBoxPlot) GetP99Column() float32 {
	if m != nil {
		return m.P99Column
	}
	return 0
...
type Table_ColumnDisplay struct {
	...
	//	*Table_ColumnDisplay_DisplaySpec
...
func (*Table_ColumnDisplay) Descriptor() ([]byte, []int) {
	return fileDescriptor_afbb78807ac88c00, []int{6, 1}
}
...
type Table_ColumnDisplay_DisplaySpec struct {
	DisplaySpec *types.Any `protobuf:"bytes,2,opt,name=display_spec,json=displaySpec,proto3,oneof" json:"display_spec,omitempty"`
}

func (*Table_ColumnDisplay_Name) isTable_ColumnDisplay_Column()        {}
func (*Table_ColumnDisplay_DisplaySpec) isTable_ColumnDisplay_Column() {}
...
func (m *Table_ColumnDisplay) GetDisplaySpec() *types.Any {
	if x, ok := m.GetColumn().(*Table_ColumnDisplay_DisplaySpec); ok {
...
func (*Table_ColumnDisplay) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Table_ColumnDisplay_DisplaySpec)(nil),
	}
}
...
type RequestGraph struct {
	...
	TotalRequestCount            string `protobuf:"bytes,12,opt,name=total_request_count,json=totalRequestCount,proto3" json:"total_request_count,omitempty"`
}
...
func (m *RequestGraph) GetTotalRequestCount() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Table_LatencyBoxPlot)(nil), "pl.vispb.Table.LatencyBoxPlot")
...
var fileDescriptor_afbb78807ac88c00 = []byte{
	...
	,
}
...
func (this *Table_LatencyBoxPlot) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Table_LatencyBoxPlot)
	if !ok {
		that2, ok := that.(Table_LatencyBoxPlot)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Table_ColumnDisplay_DisplaySpec) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Table_ColumnDisplay_DisplaySpec)
	if !ok {
		that2, ok := that.(Table_ColumnDisplay_DisplaySpec)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *RequestGraph) Equal(that interface{}) bool {
	...
	if this.TotalRequestCount != that1.TotalRequestCount {
		return false
	}
	return true
}
...
func (this *Table_LatencyBoxPlot) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&pl_vispb.Table_LatencyBoxPlot{")
...
func (this *Table_ColumnDisplay_DisplaySpec) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&pl_vispb.Table_ColumnDisplay_DisplaySpec{` +
		`DisplaySpec:` + fmt.Sprintf("%#v", this.DisplaySpec) + `}`}, ", ")
	return s
}
...
func (this *RequestGraph) GoString() string {
	...
	s = append(s, "TotalRequestCount: "+fmt.Sprintf("%#v", this.TotalRequestCount)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Table_LatencyBoxPlot) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Table_LatencyBoxPlot) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Table_LatencyBoxPlot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.P99Column != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.P99Column))))
		i--
		dAtA[i] = 0x1d
	}
	if m.P90Column != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.P90Column))))
		i--
		dAtA[i] = 0x15
	}
	if m.P50Column != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.P50Column))))
		i--
		dAtA[i] = 0xd
	}
	return len(dAtA) - i, nil
...
func (m *Table_ColumnDisplay_DisplaySpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Table_ColumnDisplay_DisplaySpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DisplaySpec != nil {
		{
			size, err := m.DisplaySpec.MarshalToSizedBuffer(dAtA[:i])
...
func (m *RequestGraph) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TotalRequestCount) > 0 {
		i -= len(m.TotalRequestCount)
		copy(dAtA[i:], m.TotalRequestCount)
		i = encodeVarintVis(dAtA, i, uint64(len(m.TotalRequestCount)))
		i--
		dAtA[i] = 0x62
	}
...
func (m *Table_LatencyBoxPlot) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Table_ColumnDisplay_DisplaySpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *Table_LatencyBoxPlot) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Table_LatencyBoxPlot{`,
...
func (this *Table_ColumnDisplay_DisplaySpec) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Table_ColumnDisplay_DisplaySpec{`,
		`DisplaySpec:` + strings.Replace(fmt.Sprintf("%v", this.DisplaySpec), "Any", "types.Any", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (this *RequestGraph) String() string {
	...
	s := strings.Join([]string{`&RequestGraph{`,
		...
		`TotalRequestCount:` + fmt.Sprintf("%v", this.TotalRequestCount) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Table_LatencyBoxPlot) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LatencyBoxPlot: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LatencyBoxPlot: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 5 {
			...
			iNdEx += 4
			m.P50Column = float32(math.Float32frombits(v))
		case 2:
			if wireType != 5 {
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.P90Column = float32(math.Float32frombits(v))
		case 3:
			if wireType != 5 {
			...
			v = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.P99Column = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipVis(dAtA[iNdEx:])
			if err != nil {
...
func (m *Table_ColumnDisplay) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Column = &Table_ColumnDisplay_DisplaySpec{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *RequestGraph) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalRequestCount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalRequestCount = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipVis(dAtA[iNdEx:])
