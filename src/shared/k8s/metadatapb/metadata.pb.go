...
type PodConditionStatus int32

const (
	STATUS_UNKNOWN PodConditionStatus = 0
	STATUS_TRUE    PodConditionStatus = 1
	STATUS_FALSE   PodConditionStatus = 2
)

var PodConditionStatus_name = map[int32]string{
	0: "STATUS_UNKNOWN",
	1: "STATUS_TRUE",
	2: "STATUS_FALSE",
}

var PodConditionStatus_value = map[string]int32{
	"STATUS_UNKNOWN": 0,
	"STATUS_TRUE":    1,
	"STATUS_FALSE":   2,
}

func (PodConditionStatus) EnumDescriptor() ([]byte, []int) {
...
type PodCondition struct {
	Type   PodConditionType   `protobuf:"varint,1,opt,name=type,proto3,enum=pl.shared.k8s.metadatapb.PodConditionType" json:"type,omitempty"`
	Status PodConditionStatus `protobuf:"varint,2,opt,name=status,proto3,enum=pl.shared.k8s.metadatapb.PodConditionStatus" json:"status,omitempty"`
}
...
func (m *PodCondition) GetStatus() PodConditionStatus {
	if m != nil {
		return m.Status
	}
...
type ContainerUpdate struct {
	...
	ContainerType    ContainerType  `protobuf:"varint,11,opt,name=container_type,json=containerType,proto3,enum=pl.shared.k8s.metadatapb.ContainerType" json:"container_type,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("pl.shared.k8s.metadatapb.PodConditionStatus", PodConditionStatus_name, PodConditionStatus_value)
	...
	proto.RegisterEnum("pl.shared.k8s.metadatapb.ContainerType", ContainerType_name, ContainerType_value)
	...
	proto.RegisterMapType((map[string]string)(nil), "pl.shared.k8s.metadatapb.ObjectMetadata.AnnotationsEntry")
	...
	proto.RegisterType((*K8SEvent)(nil), "pl.shared.k8s.metadatapb.K8sEvent")
	proto.RegisterType((*PodStatus)(nil), "pl.shared.k8s.metadatapb.PodStatus")
	proto.RegisterType((*PodCondition)(nil), "pl.shared.k8s.metadatapb.PodCondition")
	...
	proto.RegisterType((*MissingK8SMetadataRequest)(nil), "pl.shared.k8s.metadatapb.MissingK8sMetadataRequest")
	proto.RegisterType((*MissingK8SMetadataResponse)(nil), "pl.shared.k8s.metadatapb.MissingK8sMetadataResponse")
}
...
var fileDescriptor_281217845a4326db = []byte{
	...
	,
}
...
func (x PodConditionStatus) String() string {
	s, ok := PodConditionStatus_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *K8SEvent) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&pl_shared_k8s_metadatapb.K8SEvent{")
	s = append(s, "Message: "+fmt.Sprintf("%#v", this.Message)+",\n")
...
func (this *PodCondition) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&pl_shared_k8s_metadatapb.PodCondition{")
...
func (this *MissingK8SMetadataRequest) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&pl_shared_k8s_metadatapb.MissingK8SMetadataRequest{")
...
func (this *MissingK8SMetadataResponse) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&pl_shared_k8s_metadatapb.MissingK8SMetadataResponse{")
	if this.Updates != nil {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= PodConditionStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
