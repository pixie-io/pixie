...
type ResourceUpdate2 struct {
	// Types that are valid to be assigned to Update:
	//	*ResourceUpdate2_PodUpdate
	//	*ResourceUpdate2_ContainerUpdate
	//	*ResourceUpdate2_ServiceUpdate
	Update isResourceUpdate2_Update `protobuf_oneof:"update"`
}

func (m *ResourceUpdate2) Reset()      { *m = ResourceUpdate2{} }
func (*ResourceUpdate2) ProtoMessage() {}
func (*ResourceUpdate2) Descriptor() ([]byte, []int) {
	return fileDescriptor_281217845a4326db, []int{20}
}
func (m *ResourceUpdate2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResourceUpdate2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResourceUpdate2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ResourceUpdate2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResourceUpdate2.Merge(m, src)
}
func (m *ResourceUpdate2) XXX_Size() int {
	return m.Size()
}
func (m *ResourceUpdate2) XXX_DiscardUnknown() {
	xxx_messageInfo_ResourceUpdate2.DiscardUnknown(m)
}

var xxx_messageInfo_ResourceUpdate2 proto.InternalMessageInfo

type isResourceUpdate2_Update interface {
	isResourceUpdate2_Update()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type ResourceUpdate2_PodUpdate struct {
	PodUpdate *PodUpdate `protobuf:"bytes,1,opt,name=pod_update,json=podUpdate,proto3,oneof"`
}
type ResourceUpdate2_ContainerUpdate struct {
	ContainerUpdate *ContainerUpdate `protobuf:"bytes,2,opt,name=container_update,json=containerUpdate,proto3,oneof"`
}
type ResourceUpdate2_ServiceUpdate struct {
	ServiceUpdate *ServiceUpdate `protobuf:"bytes,3,opt,name=service_update,json=serviceUpdate,proto3,oneof"`
}

func (*ResourceUpdate2_PodUpdate) isResourceUpdate2_Update()       {}
func (*ResourceUpdate2_ContainerUpdate) isResourceUpdate2_Update() {}
func (*ResourceUpdate2_ServiceUpdate) isResourceUpdate2_Update()   {}

func (m *ResourceUpdate2) GetUpdate() isResourceUpdate2_Update {
	if m != nil {
		return m.Update
	}
	return nil
...
func (m *ResourceUpdate2) GetPodUpdate() *PodUpdate {
	if x, ok := m.GetUpdate().(*ResourceUpdate2_PodUpdate); ok {
		return x.PodUpdate
	}
	return nil
}

func (m *ResourceUpdate2) GetContainerUpdate() *ContainerUpdate {
	if x, ok := m.GetUpdate().(*ResourceUpdate2_ContainerUpdate); ok {
		return x.ContainerUpdate
	}
	return nil
}

func (m *ResourceUpdate2) GetServiceUpdate() *ServiceUpdate {
	if x, ok := m.GetUpdate().(*ResourceUpdate2_ServiceUpdate); ok {
...
func (*ResourceUpdate2) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ResourceUpdate2_OneofMarshaler, _ResourceUpdate2_OneofUnmarshaler, _ResourceUpdate2_OneofSizer, []interface{}{
		(*ResourceUpdate2_PodUpdate)(nil),
		(*ResourceUpdate2_ContainerUpdate)(nil),
		(*ResourceUpdate2_ServiceUpdate)(nil),
	}
}

func _ResourceUpdate2_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ResourceUpdate2)
	// update
	switch x := m.Update.(type) {
	case *ResourceUpdate2_PodUpdate:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.PodUpdate); err != nil {
			return err
		}
	case *ResourceUpdate2_ContainerUpdate:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ContainerUpdate); err != nil {
			return err
		}
	case *ResourceUpdate2_ServiceUpdate:
	...
	case nil:
	default:
		return fmt.Errorf("ResourceUpdate2.Update has unexpected type %T", x)
	}
	return nil
}

func _ResourceUpdate2_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ResourceUpdate2)
	switch tag {
	case 1: // update.pod_update
		...
		m.Update = &ResourceUpdate2_PodUpdate{msg}
		return true, err
	case 2: // update.container_update
		...
		err := b.DecodeMessage(msg)
		m.Update = &ResourceUpdate2_ContainerUpdate{msg}
		return true, err
	case 3: // update.service_update
		...
		err := b.DecodeMessage(msg)
		m.Update = &ResourceUpdate2_ServiceUpdate{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ResourceUpdate2_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ResourceUpdate2)
	// update
	switch x := m.Update.(type) {
	case *ResourceUpdate2_PodUpdate:
...
func init() {
	...
	proto.RegisterType((*ResourceUpdate2)(nil), "pl.shared.k8s.metadatapb.ResourceUpdate2")
...
var fileDescriptor_281217845a4326db = []byte{
	...
	,
}
...
func (this *ResourceUpdate2) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ResourceUpdate2)
	if !ok {
		that2, ok := that.(ResourceUpdate2)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ResourceUpdate2_PodUpdate) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ResourceUpdate2_PodUpdate)
	if !ok {
		that2, ok := that.(ResourceUpdate2_PodUpdate)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ResourceUpdate2_ContainerUpdate) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ResourceUpdate2_ContainerUpdate)
	if !ok {
		that2, ok := that.(ResourceUpdate2_ContainerUpdate)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ResourceUpdate2_ServiceUpdate) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ResourceUpdate2_ServiceUpdate)
	if !ok {
		that2, ok := that.(ResourceUpdate2_ServiceUpdate)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ResourceUpdate2) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&pl_shared_k8s_metadatapb.ResourceUpdate2{")
	if this.Update != nil {
...
func (this *ResourceUpdate2_PodUpdate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&pl_shared_k8s_metadatapb.ResourceUpdate2_PodUpdate{` +
		`PodUpdate:` + fmt.Sprintf("%#v", this.PodUpdate) + `}`}, ", ")
	return s
}
func (this *ResourceUpdate2_ContainerUpdate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&pl_shared_k8s_metadatapb.ResourceUpdate2_ContainerUpdate{` +
		`ContainerUpdate:` + fmt.Sprintf("%#v", this.ContainerUpdate) + `}`}, ", ")
	return s
}
func (this *ResourceUpdate2_ServiceUpdate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&pl_shared_k8s_metadatapb.ResourceUpdate2_ServiceUpdate{` +
...
func (m *ResourceUpdate2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ResourceUpdate2) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ResourceUpdate2_PodUpdate) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.PodUpdate != nil {
		dAtA[i] = 0xa
		i++
...
func (m *ResourceUpdate2_ContainerUpdate) MarshalTo(dAtA []byte) (int, error) {
	i := 0
...
func (m *ResourceUpdate2_ServiceUpdate) MarshalTo(dAtA []byte) (int, error) {
	i := 0
...
func (m *ResourceUpdate2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResourceUpdate2_PodUpdate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResourceUpdate2_ContainerUpdate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResourceUpdate2_ServiceUpdate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ResourceUpdate2) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ResourceUpdate2{`,
		`Update:` + fmt.Sprintf("%v", this.Update) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ResourceUpdate2_PodUpdate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ResourceUpdate2_PodUpdate{`,
		`PodUpdate:` + strings.Replace(fmt.Sprintf("%v", this.PodUpdate), "PodUpdate", "PodUpdate", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ResourceUpdate2_ContainerUpdate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ResourceUpdate2_ContainerUpdate{`,
		`ContainerUpdate:` + strings.Replace(fmt.Sprintf("%v", this.ContainerUpdate), "ContainerUpdate", "ContainerUpdate", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ResourceUpdate2_ServiceUpdate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ResourceUpdate2_ServiceUpdate{`,
...
func (m *ResourceUpdate2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResourceUpdate2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResourceUpdate2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Update = &ResourceUpdate2_PodUpdate{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Update = &ResourceUpdate2_ContainerUpdate{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Update = &ResourceUpdate2_ServiceUpdate{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMetadata(dAtA[iNdEx:])
