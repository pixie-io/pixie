...
func schemaJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema.json", size: 825, mode: os.FileMode(436), modTime: time.Unix(1583284430, 0)}
