...
func _000005_create_user_settings_tableDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000005_create_user_settings_table.down.sql", size: 36, mode: os.FileMode(436), modTime: time.Unix(1605824213, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000005_create_user_settings_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000005_create_user_settings_table.up.sql", size: 192, mode: os.FileMode(436), modTime: time.Unix(1605824344, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
