...
func (m *MockProjectManagerServiceClient) GetProjectForOrg(ctx context.Context, in *proto.UUID, opts ...grpc.CallOption) (*projectmanagerpb.ProjectInfo, error) {
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
// GetProjectForOrg mocks base method
func (m *MockProjectManagerServiceServer) GetProjectForOrg(arg0 context.Context, arg1 *proto.UUID) (*projectmanagerpb.ProjectInfo, error) {
