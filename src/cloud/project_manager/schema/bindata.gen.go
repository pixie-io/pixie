...
func _000001_create_sites_tableDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_create_sites_table.down.sql", size: 28, mode: os.FileMode(436), modTime: time.Unix(1618706976, 0)}
...
func _000001_create_sites_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_create_sites_table.up.sql", size: 167, mode: os.FileMode(436), modTime: time.Unix(1618706976, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000002_create_site_name_columnDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000002_create_site_name_column.down.sql", size: 146, mode: os.FileMode(436), modTime: time.Unix(1618706976, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000002_create_site_name_columnUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000002_create_site_name_column.up.sql", size: 103, mode: os.FileMode(436), modTime: time.Unix(1618706976, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000003_rename_sites_to_projectsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000003_rename_sites_to_projects.down.sql", size: 187, mode: os.FileMode(436), modTime: time.Unix(1618706976, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000003_rename_sites_to_projectsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000003_rename_sites_to_projects.up.sql", size: 209, mode: os.FileMode(436), modTime: time.Unix(1618706976, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
