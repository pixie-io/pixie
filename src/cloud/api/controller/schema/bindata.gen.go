...
func schemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema.graphql", size: 6298, mode: os.FileMode(436), modTime: time.Unix(1, 0)}
