...
func schemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema.graphql", size: 1847, mode: os.FileMode(436), modTime: time.Unix(1584145236, 0)}
