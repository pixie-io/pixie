...
func _03_auth_schemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "03_auth_schema.graphql", size: 8053, mode: os.FileMode(436), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
