...
func _000006_add_project_id_to_cluster_tableDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000006_add_project_id_to_cluster_table.down.sql", size: 108, mode: os.FileMode(436), modTime: time.Unix(1584996174, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000006_add_project_id_to_cluster_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000006_add_project_id_to_cluster_table.up.sql", size: 163, mode: os.FileMode(436), modTime: time.Unix(1584996174, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
