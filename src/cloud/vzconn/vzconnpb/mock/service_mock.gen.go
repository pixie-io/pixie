...
// Source: px.dev/pixie/src/cloud/vzconn/vzconnpb (interfaces: VZConnServiceServer,VZConnServiceClient,VZConnService_NATSBridgeServer,VZConnService_NATSBridgeClient)
