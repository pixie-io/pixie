...
func _000001_add_api_keysDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_add_api_keys.down.sql", size: 31, mode: os.FileMode(436), modTime: time.Unix(1619557891, 0)}
...
func _000001_add_api_keysUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_add_api_keys.up.sql", size: 624, mode: os.FileMode(436), modTime: time.Unix(1619557891, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
