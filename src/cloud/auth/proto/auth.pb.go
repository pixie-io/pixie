...
func (*GetAPIKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_65c67b365074056c, []int{13}
}
...
func (*GetAPIKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_65c67b365074056c, []int{14}
}
...
func init() {
	...
	proto.RegisterType((*GetAugmentedTokenForAPIKeyRequest)(nil), "pl.services.GetAugmentedTokenForAPIKeyRequest")
	proto.RegisterType((*GetAugmentedTokenForAPIKeyResponse)(nil), "pl.services.GetAugmentedTokenForAPIKeyResponse")
...
var fileDescriptor_65c67b365074056c = []byte{
	...
	,
}
...
func (this *GetAugmentedTokenForAPIKeyRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&auth.GetAugmentedTokenForAPIKeyRequest{")
...
func (this *GetAugmentedTokenForAPIKeyResponse) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&auth.GetAugmentedTokenForAPIKeyResponse{")
	s = append(s, "Token: "+fmt.Sprintf("%#v", this.Token)+",\n")
	s = append(s, "ExpiresAt: "+fmt.Sprintf("%#v", this.ExpiresAt)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
...
func (c *authServiceClient) GetAugmentedTokenForAPIKey(ctx context.Context, in *GetAugmentedTokenForAPIKeyRequest, opts ...grpc.CallOption) (*GetAugmentedTokenForAPIKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pl.services.AuthService/GetAugmentedTokenForAPIKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_GetAugmentedTokenForAPIKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pl.services.AuthService/GetAugmentedTokenForAPIKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
