...
func _000001_create_dns_tablesDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_create_dns_tables.down.sql", size: 68, mode: os.FileMode(436), modTime: time.Unix(1618706976, 0)}
...
func _000001_create_dns_tablesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_create_dns_tables.up.sql", size: 733, mode: os.FileMode(436), modTime: time.Unix(1618706976, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
