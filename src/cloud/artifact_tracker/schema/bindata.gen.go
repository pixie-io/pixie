...
func _000001_create_artifact_tablesDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_create_artifact_tables.down.sql", size: 133, mode: os.FileMode(436), modTime: time.Unix(1571422685, 0)}
...
func _000001_create_artifact_tablesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_create_artifact_tables.up.sql", size: 829, mode: os.FileMode(436), modTime: time.Unix(1571422708, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
