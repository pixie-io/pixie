...
func _000001_create_artifact_tablesDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_create_artifact_tables.down.sql", size: 133, mode: os.FileMode(436), modTime: time.Unix(1619552691, 0)}
...
func _000001_create_artifact_tablesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_create_artifact_tables.up.sql", size: 829, mode: os.FileMode(436), modTime: time.Unix(1619552691, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000002_add_container_yamlsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000002_add_container_yamls.down.sql", size: 59, mode: os.FileMode(436), modTime: time.Unix(1619552691, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000002_add_container_yamlsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000002_add_container_yamls.up.sql", size: 93, mode: os.FileMode(436), modTime: time.Unix(1619552691, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000003_add_container_tmpl_yamlsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000003_add_container_tmpl_yamls.down.sql", size: 68, mode: os.FileMode(436), modTime: time.Unix(1619552691, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000003_add_container_tmpl_yamlsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000003_add_container_tmpl_yamls.up.sql", size: 67, mode: os.FileMode(436), modTime: time.Unix(1619552691, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
