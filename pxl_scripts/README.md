...
- px/[agent_status](https://github.com/pixie-labs/pixie/tree/main/pxl_scripts/px/agent_status): Gets the status of all the Pixie agents (PEMs/Collectors) running.
...
- px/[mysql_data](https://github.com/pixie-labs/pixie/tree/main/pxl_scripts/px/mysql_data): Shows a sample of MySQL request in the cluster.
...
- px/[net_flow_graph](https://github.com/pixie-labs/pixie/tree/main/pxl_scripts/px/net_flow_graph): The set of k8s pods that talk to the specified IPs. Shows a graph and a table of the connections. Calculates total bandwidth for the lifetime of the connection.
...
- px/[pod_edge_stats](https://github.com/pixie-labs/pixie/tree/main/pxl_scripts/px/pod_edge_stats): Gets pod latency, error rate and throughput according to another service. Edit the requestor filter to the name of the incoming service you want to filter by. Visualize these in three separate time series charts.
...
- px/[upids](https://github.com/pixie-labs/pixie/tree/main/pxl_scripts/px/upids): Returns information about tracepoints running on the cluster.
