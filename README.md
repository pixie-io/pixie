...
- [Cloud v0.1.2](https://github.com/pixie-io/pixie/releases/tag/release/cloud/v0.1.2)<!--cloud-latest-release-->
- [Vizier v0.13.8-pre-gen-manifest-updates-from-mirrors.8](https://github.com/JamesMBartlett/pixie/releases/tag/release/vizier/v0.13.8-pre-gen-manifest-updates-from-mirrors.8)<!--vizier-latest-release-->
