...
- [Vizier v0.13.8-pre-gen-manifest-updates-from-mirrors.10](https://github.com/pixie-io/pixie/releases/tag/release/vizier/v0.13.8-pre-gen-manifest-updates-from-mirrors.10)<!--vizier-latest-release-->
- [Operator v0.1.3](https://github.com/pixie-io/pixie/releases/tag/release/operator/v0.1.3)<!--operator-latest-release-->
