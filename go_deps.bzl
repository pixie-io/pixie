...
def pl_go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:WQQ40AAlqqfx+f6ku+i0pOVm+ASirD4fUh+oQsiE9Ak=",
        version = "v2.5.0",
    )
    go_repository(
        ...
        sum = "h1:Th4G6zdsz2d0OqXdfzKLClo6bOfoI/b1kInhRtFIy5c=",
        version = "v1.28.0",
    )
    go_repository(
        ...
        sum = "h1:6Wj6H6QpP9FMlpCyWUaNu2yeZ/qGj+mdRkZ1wbikExU=",
        version = "v2.9.23",
    )
    go_repository(
