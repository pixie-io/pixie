...
def pl_go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:rbe942bXzd2vnds4y9fYQL8X4yFltXoZsKW7KtG+TFM=",
        version = "v0.0.0-20210223225224-5bea62493d91",
    )
    ...
    go_repository(
        name = "com_github_centrifugal_centrifuge_go",
        importpath = "github.com/centrifugal/centrifuge-go",
        sum = "h1:y3EMYwB3hpp6IUKq6aWuSmijKBmeCm6cekZYWzP25Ms=",
        version = "v0.7.1",
    )
    go_repository(
        name = "com_github_centrifugal_protocol",
        importpath = "github.com/centrifugal/protocol",
        sum = "h1:3Tu1iNoKfEw5xkJotKm2or0vhyOl4HtfPbGSDnEWoGA=",
        version = "v0.3.5",
    )
    ...
    go_repository(
        ...
        sum = "h1:C8u/Ljj8G8O6rqWJh2J8cDyeEFBMWvXlvJ/ccMyzcqw=",
        version = "v22.3.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_grafana_grafana_plugin_sdk_go",
        importpath = "github.com/grafana/grafana-plugin-sdk-go",
        sum = "h1:kiPS3NqR+KOvHrc32EkX7D40JON3+GYZ6Nm2WOtCElQ=",
        version = "v0.91.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:mgDpq0PkoK5gck2w4ivaMpWRHv/matdOR4xmeScmf/w=",
        version = "v1.2.2",
    )
    ...
    go_repository(
        name = "com_github_mattetti_filebuffer",
        importpath = "github.com/mattetti/filebuffer",
        sum = "h1:gG7pyfnSIZCxdoKq+cPa8T0hhYtD9NxCdI4D7PTjRLM=",
        version = "v1.0.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:dr1EOILak2pu4Nf5XbRIOCNIBjcz6UmkQd7hHRXwxaM=",
        version = "v3.5.0-alpha.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:VIT1Y6ty6TsZaKXiyqH94U+7vR0pUpBQ1UCrTNoS+UU=",
        version = "v0.20.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JmmGqBM7CaJRUKL6oVFoiM7BT2hE9cxg/yjrPkMhSbk=",
        version = "v0.20.5",
    )
    go_repository(
        name = "io_k8s_gengo",
    ...
    go_repository(
        ...
        sum = "h1:/wndy8hw5TsL8G8KWPDJrtPKS8D34uSdWS0BMRmtzWs=",
        version = "v0.20.5",
    )
    ...
    go_repository(
        ...
        sum = "h1:cQaav6lMGpYJPnS6G9jTCVmv531JVX1xEVv7WGUgNyM=",
        version = "v0.20.5",
    )
